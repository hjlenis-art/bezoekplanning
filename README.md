...
<div id="mainPage" class="page active">
  ...
  <button class="main" onclick="showPage('formPage')">Nieuwe inschrijving</button>
  <button class="main" onclick="showPage('entriesPage')">Inschrijvingen bekijken</button>

</div>

<!-- INSCHRIJVINGEN (ACHTER KNOP) -->
...
function renderWeek(){
  const b=document.getElementById("weekBody");
  b.innerHTML="";
  for(let i=0;i<7;i++){
...
function renderEntries(){
  ...
  entries
    ...
    .forEach(e=>{
      ...
      d.className="entry";
      d.innerHTML=`<strong>${e.naam}</strong><br>
        ${e.datum} • ${timeLabel(e.tijd)}<br>
